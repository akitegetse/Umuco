...
foreach(_expectedTarget hdf5 hdf5_tools hdf5_hl hdf5_f90cstub hdf5_fortran hdf5_hl_f90cstub hdf5_hl_fortran hdf5_cpp hdf5_hl_cpp)
...
set_target_properties(hdf5_f90cstub PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "hdf5;zlib;szip"
)
...
set_target_properties(hdf5_fortran PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "hdf5_f90cstub;hdf5"
)
...
set_target_properties(hdf5_hl_f90cstub PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "hdf5_f90cstub;hdf5_hl"
)
...
set_target_properties(hdf5_hl_fortran PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "hdf5_hl_f90cstub;hdf5_fortran"
)
